...
final class ConfluenceCanvasFactory {
    ...
    static UIElement transmutation(UIElement input, UIElement[] targets, UIElement phase) {
    ...
    static UIElement amount(UIElement[] inputs, UIElement output) {
    ...
    static UIElement forge(UIElement[] inputs, UIElement output) {
        return amount(inputs, output);
    }

    static UIElement either(UIElement[] inputs, UIElement output) {
    ...
    static UIElement alchemy(UIElement[] inputs, UIElement output) {
    ...
    static UIElement fletching(UIElement[] inputs, UIElement output) {
    ...
    static UIElement cooking(UIElement[] inputs, UIElement container, UIElement heat, UIElement output) {
