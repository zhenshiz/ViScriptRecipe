...
/** Editable representation of {@code LaserDrillFluidRecipe.CODEC}. */
@Getter
@Setter
@Accessors(chain = true)
public class IndustrialLaserDrillFluidRecipeData implements IPersistedSerializable, IConfigurable {
