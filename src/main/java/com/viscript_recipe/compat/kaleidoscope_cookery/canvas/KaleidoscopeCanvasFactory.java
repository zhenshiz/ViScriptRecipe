...
public final class KaleidoscopeCanvasFactory {
    private static final int JEI_SLOT_SIZE = 18;

    private KaleidoscopeCanvasFactory() {
    }

    public static UIElement createPotCanvas(UIElement[] ingredientSlots, UIElement carrierSlot, UIElement resultSlot, Label stirFryLabel) {
    ...
    public static UIElement createStockpotCanvas(
    ...
    public static UIElement createSteamerCanvas(UIElement inputSlot, UIElement resultSlot) {
