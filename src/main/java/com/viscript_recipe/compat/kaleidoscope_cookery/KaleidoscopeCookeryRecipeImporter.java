...
public final class KaleidoscopeCookeryRecipeImporter implements RecipeImportHandler {
    ...
    public RecipeImportResult tryImport(RecipeHolder<?> holder, HolderLookup.Provider provider) throws RecipeImportException {
        ...
        if (recipe instanceof PotRecipe pot) {
            ...
            return RecipeImporter.success(RecipeImporter.baseEntry(holder.id(), RecipeEditorTypes.KALEIDOSCOPE_COOKERY_POT).setKaleidoscopePot(data));
        }
        if (recipe instanceof StockpotRecipe stockpot) {
            ...
            return RecipeImporter.success(RecipeImporter.baseEntry(holder.id(), RecipeEditorTypes.KALEIDOSCOPE_COOKERY_STOCKPOT).setKaleidoscopeStockpot(data));
        }
        if (recipe instanceof MillstoneRecipe millstone) {
            ...
            return RecipeImporter.success(RecipeImporter.baseEntry(holder.id(), RecipeEditorTypes.KALEIDOSCOPE_COOKERY_MILLSTONE).setKaleidoscopeMillstone(data));
        }
        if (recipe instanceof ChoppingBoardRecipe choppingBoard) {
            ...
            return RecipeImporter.success(RecipeImporter.baseEntry(holder.id(), RecipeEditorTypes.KALEIDOSCOPE_COOKERY_CHOPPING_BOARD).setKaleidoscopeChoppingBoard(data));
        }
        if (recipe instanceof SteamerRecipe steamer) {
            ...
            return RecipeImporter.success(RecipeImporter.baseEntry(holder.id(), RecipeEditorTypes.KALEIDOSCOPE_COOKERY_STEAMER).setKaleidoscopeSteamer(data));
        }
        if (recipe instanceof TeapotRecipe teapot) {
            ...
            return RecipeImporter.success(RecipeImporter.baseEntry(holder.id(), RecipeEditorTypes.KALEIDOSCOPE_COOKERY_TEAPOT).setKaleidoscopeTeapot(data));
        }
        return null;
    }
