...
public final class CreateProcessingCanvasFactory {
    ...
    public static UIElement createProcessingStack(UIElement... canvases) {
    ...
    public static UIElement createGenericProcessingCanvas(UIElement inputSide, UIElement machineColumn, UIElement outputSide) {
        return responsiveRow(14).addChildren(inputSide, machineColumn, arrowElement(), outputSide);
    }

    public static UIElement createInputSide(UIElement itemGrid, UIElement fluidInputs) {
        return RecipeEditorUi.column().layout(layout -> {
    ...
    public static UIElement createMachineColumn(UIElement machineIcon, Label machineLabel) {
    ...
    public static UIElement createOutputSide(UIElement itemGrid, UIElement fluidOutputs) {
        return RecipeEditorUi.column().layout(layout -> {
    ...
    public static UIElement createSpoutCanvas(UIElement fluidInputSlot, UIElement ingredientSlot, UIElement outputSlot) {
    ...
    public static UIElement createDrainCanvas(UIElement ingredientSlot, UIElement fluidOutputSlot, UIElement outputSlot) {
    ...
    public static UIElement createFanCanvas(UIElement ingredientSlot, UIElement catalystIcon, Label catalystLabel, UIElement singleOutputSlot, UIElement multiOutputGrid) {
        UIElement singleOutputPanel = null;
        if (singleOutputSlot != null) singleOutputPanel = RecipeEditorUi.column().layout(layout -> {
        ...
        UIElement multiOutputPanel = null;
        if (multiOutputGrid != null) multiOutputPanel = RecipeEditorUi.column().layout(layout -> {
        ...
        if (singleOutputPanel != null) root.addChild(singleOutputPanel);
        if (multiOutputPanel != null) root.addChild(multiOutputPanel);
        return root;
    }

    public static UIElement createCrushingCanvas(UIElement ingredientSlot, UIElement outputRow) {
        return RecipeEditorUi.column().layout(layout -> {
            layout.widthPercent(100);
            layout.flex(1);
            layout.gapAll(4);
    ...
    public static UIElement createMillingCanvas(UIElement ingredientSlot, UIElement outputRow) {
    ...
    public static UIElement createSawCanvas(UIElement ingredientSlot, UIElement outputGrid) {
    ...
    public static UIElement createAutoPackingCanvas(UIElement inputGrid, UIElement outputSlot) {
    ...
    public static UIElement createSandpaperCanvas(UIElement ingredientSlot, UIElement outputSlot) {
        return responsiveRow(14).addChildren(
                ingredientSlot,
                RecipeEditorUi.column().layout(layout -> {
    ...
    public static UIElement createPressingCanvas(UIElement ingredientSlot, UIElement outputRow) {
        return responsiveRow(12).addChildren(
                RecipeEditorUi.column().layout(layout -> {
                    boundedWidth(layout, 56);
                    layout.height(132);
    ...
    public static UIElement createPressBasinCanvas(UIElement inputSide, UIElement machineStack, UIElement outputSide, UIElement heatPanel) {
        return RecipeEditorUi.column().layout(layout -> {
            layout.widthPercent(100);
            layout.flex(1);
            layout.gapAll(12);
    ...
    public static UIElement createAutomaticBrewingCanvas(UIElement ingredientSlot, UIElement fluidInputSlot, UIElement fluidOutputSlot, UIElement heatPanel) {
        return RecipeEditorUi.column().layout(layout -> {
            layout.widthPercent(100);
            layout.flex(1);
            layout.gapAll(12);
    ...
    public static UIElement createPressInputSide(UIElement itemInputs, UIElement fluidInputs) {
        return RecipeEditorUi.column().layout(layout -> {
            boundedWidth(layout, 120);
            layout.gapAll(7);
            layout.alignItems(AlignItems.CENTER);
    ...
    public static UIElement createPressMachineStack(UIElement machineIcon) {
        machineIcon.layout(layout -> {
            layout.width(82);
            layout.height(82);
        });
    ...
    public static UIElement createPressOutputSide(UIElement itemOutputs, UIElement fluidOutputs) {
        return RecipeEditorUi.column().layout(layout -> {
            boundedWidth(layout, 118);
            layout.gapAll(7);
            layout.alignItems(AlignItems.CENTER);
    ...
    public static UIElement createPressHeatPanel(UIElement heatLabel) {
    ...
    public static UIElement createDeployerCanvas(UIElement heldSlot, UIElement processedSlot, UIElement outputGrid) {
        return responsiveRow(12).addChildren(
                RecipeEditorUi.column().layout(layout -> {
                    boundedWidth(layout, 56);
                    layout.height(132);
    ...
    public static UIElement createManualApplicationCanvas(UIElement blockSlot, UIElement processStack, UIElement outputGrid) {
        return responsiveRow(12).addChildren(
                RecipeEditorUi.column().layout(layout -> {
                    boundedWidth(layout, 60);
                    layout.height(132);
    ...
    public static UIElement framedSlot(UIElement slot, int size) {
