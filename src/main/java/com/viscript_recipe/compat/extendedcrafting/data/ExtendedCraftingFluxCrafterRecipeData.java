...
public class ExtendedCraftingFluxCrafterRecipeData implements IVSRecipeData {
    ...
    public void applyDefaultData(ResourceLocation typeId) {
        setPattern(new ArrayList<>(List.of(
                ...
                .setResult(new ItemStack(com.viscript_recipe.recipe.RecipeHelper.itemFromRegistry("extendedcrafting:flux_star", Items.REDSTONE)))
                .setPowerRequired(typeId.equals(ExtendedCraftingRecipeEditorTypes.SHAPELESS_FLUX_CRAFTER) ? 200000 : 400000);
    }
}
