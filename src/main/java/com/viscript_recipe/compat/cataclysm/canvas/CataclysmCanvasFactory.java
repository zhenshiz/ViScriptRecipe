...
public final class CataclysmCanvasFactory {
    ...
    public static UIElement createWeaponFusionCanvas(UIElement baseSlot, UIElement additionSlot, UIElement resultSlot) {
    ...
    public static UIElement createAmethystBlessCanvas(UIElement ingredientSlot, UIElement resultSlot) {
